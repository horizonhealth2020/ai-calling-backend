...
- [x] 47-05-PLAN.md — Closed-period chargeback → cross-period negative row in oldest OPEN period + orange/yellow highlights (includes schema enum additions + prisma db push)
